...
var simulation = d3.forceSimulation()  //創造一個新的simulation (這個模型包含著一個nodes的數組)  //看第94行
    .force("link", d3.forceLink().id(function (d) {return d.id}).distance(180)) //節點之間的距離
    .force("charge", d3.forceManyBody())
	
    .force("center", d3.forceCenter(width / 3, height / 3)) //起始位置
	.force('charge', d3.forceManyBody().strength(-150)); //引力設定，負數為排斥，正數為吸引，避免節點重疊
